...
# --- OCR SERVICE CORRIGIDO (isRunning -> isServiceRunning) ---
ocr_service_content = """
...
class OcrService : Service() {
    ...
    private fun setupMediaProjection(code: Int, data: Intent) {
        try {
            ...
            // CORREÇÃO AQUI: isRunning -> isServiceRunning
            isServiceRunning = true 
            startOcrLoop()
...
print("--- Variável isRunning Corrigida ---")
create_file("app/src/main/java/com/motoristapro/android/OcrService.kt", ocr_service_content)

print("\nExecute:")
print("1. git add .")
print("2. git commit -m 'Fix: Variable Name isServiceRunning'")
print("3. git push")
