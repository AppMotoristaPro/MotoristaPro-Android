...
# --- OCR SERVICE CORRIGIDO (Variáveis de Classe) ---
ocr_service_content = """
...
class OcrService : Service() {
    ...
    // Estados (Declarados aqui para serem globais na classe)
    ...
    override fun onCreate() {
        ...
        try {
            ...
            createInfoCard()
            createControls()
            isServiceRunning = true // Marca como rodando
