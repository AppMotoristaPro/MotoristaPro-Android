...
def main():
    print("☢️ INICIANDO RESET: WebView Simples + Botão Robô Offline...")

    base_src = "app/src/main/java/com/motoristapro/android"
    base_res = "app/src/main/res/layout"

    # ==============================================================================
    # 1. LIMPEZA (Remove telas nativas complexas)
    # ==============================================================================
    files_to_delete = [
    ...
    # ==============================================================================
    # 2. GRADLE LIMPO (Sem Room, Sem Gráficos)
    # ==============================================================================
...
"""
    ...
    # ==============================================================================
    # 5. MAIN ACTIVITY KOTLIN (Lógica Simples)
    # ==============================================================================
...
"""
    ...
    print("\n✅ APP SIMPLIFICADO!")
    print("👉 1. Limpe o build: ./gradlew clean")
    print("👉 2. Compile: ./gradlew assembleDebug")
