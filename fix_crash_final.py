...
def create_file(path, content):
    ...
    print(f"Blindado: {path}")

# --- OCR SERVICE BLINDADO PARA ANDROID 14 ---
ocr_service_content = """
...
class OcrService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        // O startForeground deve ser chamado IMEDIATAMENTE no onCreate
    ...
    private fun startForegroundServiceCompat() {
        ...
        // CORREÇÃO CRÍTICA PARA ANDROID 14:
        // É obrigatório passar o tipo MEDIA_PROJECTION aqui, senão o app CRASHA.
    ...
    private fun setupOverlay() {
        ...
        try {
            ...
            Log.e("Overlay", "Erro ao criar overlay", e)
        }
    }
    ...
    private fun setupMediaProjection(code: Int, data: Intent) {
        try {
            ...
            // Reduzimos a resolução pela metade para evitar OutOfMemory em celulares 4K
            // Isso previne crashes de memória e deixa o OCR mais rápido
            ...
            updateStatus("Erro ao iniciar captura: ${e.message}")
            stopSelf()
        }
    }
    ...
    private fun processExtractedText(rawText: String) {
        // Regex robustas com escapes duplos para o Python nao quebrar
...
print("--- Aplicando Correção Crítica para Android 14 ---")
create_file("app/src/main/java/com/motoristapro/android/OcrService.kt", ocr_service_content)

print("\nArquivo blindado.")
print("Execute:")
print("1. git add .")
print("2. git commit -m 'Fix: Crash Android 14 ServiceType'")
print("3. git push")
